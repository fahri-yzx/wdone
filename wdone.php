...
if ($lang['id']!=$language) {
	$get_lang = file_get_contents('https://raw.githubusercontent.com/fahri-yzx/wdone/master/languages/' . $language . '.json');
	if (!empty($get_lang)) {
...
<div class="row3"><?php
	...
	echo fm_home().' | ver. '.$fm_version.' | <a href="https://github.com/Den1xxx/wdone">Github</a>  | <a href="'.fm_site_url().'">.</a>';
